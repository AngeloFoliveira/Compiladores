...
comando_retorno: TK_PR_RETURN expressao TK_PR_AS tipo { $$ = asd_new("return"); checkTipoExpressaoBinaria($2->tipo, $4, get_line_number()); $$->tipo=$4; if ($2 != NULL)asd_add_child($$,$2); };
